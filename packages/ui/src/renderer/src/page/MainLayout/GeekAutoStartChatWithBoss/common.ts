import { SalaryCalculateWay, JobDetailRegExpMatchLogic } from '@job-launcher/sqlite-plugin/src/enums'
import sampleCompanyList from '@job-launcher/geek-auto-start-chat-with-boss/default-config-file/sample-company-list.json'
